...
final class SettingsVCHomeView: UIView {
    ...
    var languageButtonView = SettingsCustomButtonView(typeButton: .language)
    var contractButtonView = SettingsCustomButtonView(typeButton: .contract)
...
extension SettingsVCHomeView {
    ...
    private func toFormUIElements() {
        ...
        let mainStackView = UIStackView(
            arrangedSubviews: [languageButtonView, lineView, contractButtonView],
            axis: .vertical,
            spacing: 5
        )
