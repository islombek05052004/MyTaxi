...
final class NotificationHomeView: UIView {
    ...
    private let bellImageView = UIImageView(image: UIImage(named: "bellImage"), contentMode: .scaleAspectFit)
    
    let stackView = UIStackView(arrangedSubviews: [], axis: .vertical, spacing: 20)
